(() => {
  ...
  !(function (e) {
    ...
    (e.attachDispatcher = function (e) {
      ...
      (e.invokeMethod = function (e, t, ...n) {
        return g().invokeDotNetStaticMethod(e, t, ...n);
      }),
      (e.invokeMethodAsync = function (e, t, ...n) {
        return g().invokeDotNetStaticMethodAsync(e, t, ...n);
      }),
      (e.createJSObjectReference = h),
  ...
  const g = {
    async add(e, t, n) {
      ...
      m.set(r, e);
      const o = await w().invokeMethodAsync("AddRootComponent", t, r),
        i = new y(o, p[t]);
  ...
  class y {
    ...
    async dispose() {
      if (null !== this._componentId) {
        await w().invokeMethodAsync("RemoveRootComponent", this._componentId),
  ...
  const E = new Map(),
    ...
    A = new Map();
  function C(e, t, n) {
    return N(e, t.eventHandlerId, () =>
      I(e).invokeMethodAsync("DispatchEventAsync", t, n)
    );
  }
  function I(e) {
    const t = E.get(e);
  ...
  class D {
      ...
      for (; o; ) {
        ...
        if (m) {
          ...
          if (
            ...
            Object.prototype.hasOwnProperty.call(R, t.type) &&
              t.preventDefault(),
              C(
    ...
    getEventHandlerInfosForElement(e, t) {
      return Object.prototype.hasOwnProperty.call(e, this.eventsCollectionKey)
        ...
        : t
        ? (e[this.eventsCollectionKey] = new T())
        : null;
    }
  }
  ...
  e.attachReviver((e, t) =>
    t &&
    "object" == typeof t &&
    Object.prototype.hasOwnProperty.call(t, Z) &&
    "string" == typeof t[Z]
      ? (function (e) {
          const t = `[${q(e)}]`;
  ...
  const oe = document.createElement("template"),
    ie = document.createElementNS("http://www.w3.org/2000/svg", "g"),
    se = new Set(),
    ae = Symbol(),
    ce = Symbol();
  class le {
          ...
          Ie() &&
            (function (e, t) {
              ...
              if (
                ...
                const t = Ce(n.getAttribute("href"));
    ...
    updateComponent(e, t, n, r) {
      ...
      const s = null === (o = X(i)) || void 0 === o ? void 0 : o.getRootNode(),
        a = s && s.activeElement;
    ...
    insertElement(e, t, r, o, i, s, a) {
      ...
      var h;
      f || j(u, r, o),
        (h = u) instanceof HTMLOptionElement ? re(h) : Q in h && ne(h, h[Q]);
    }
  ...
  const Oe = {
    ...
    endLocationChanging: function (e, t) {
      Te && e === ke && (Te(t), (Te = null));
    },
    navigateTo: function (e, t) {
      Le(e, t, !0);
    },
    refresh: function (e) {
      !e && Se() ? Ae(location.href, !0) : location.reload();
    },
  ...
  function Le(e, t, n = !1) {
    const r = Ce(e),
      o = ze();
    if (t.forceLoad || !we(r) || "serverside-fullpageload" === o)
      !(function (e, t) {
        if (location.href === e) {
          const t = e + "?";
      ...
      Me(r, !1, t.replaceHistoryEntry, t.historyEntryState, n);
    else {
  ...
  async function Me(e, t, n, r = void 0, o = !1) {
    if (
      (Be(),
      (function (e) {
        const t = new URL(e);
    ...
    const i = $e();
    (o ||
      !(null == i ? void 0 : i.hasLocationChangingEventListeners) ||
      (await Je(e, r, t, i))) &&
      ((be = !0), xe(e, n, r), await je(t));
  }
  function xe(e, t, n = void 0) {
    t
      ? history.replaceState({ userState: n, _index: Re }, "", e)
      : (Re++, history.pushState({ userState: n, _index: Re }, "", e));
  }
  function Pe(e) {
  ...
  function Je(e, t, n, r) {
    return new Promise((o) => {
      Be(), ke++, (Te = o), r.locationChanging(ke, e, t, n);
    });
  }
  async function je(e, t) {
    const n = null != t ? t : location.href;
    await Promise.all(
      Array.from(De, async ([t, r]) => {
        var o, i;
        (i = t),
          E.has(i) &&
            (await r.locationChanged(
              n,
              null === (o = history.state) || void 0 === o
                ? void 0
                : o.userState,
              e
            ));
  ...
  async function He(e) {
    var t, n;
    Fe && "serverside-enhanced" !== ze() && (await Fe(e)),
      (Re =
        null !==
          (n =
  ...
  function ze() {
    return Ie()
      ...
      : Se()
      ? "serverside-enhanced"
      : window.Blazor._internal.isBlazorWeb
      ? "serverside-fullpageload"
      : "clientside-router";
  }
  const We = {
      focus: function (e, t) {
    ...
    Ue = {
      init: function (e, t, n, r = 50) {
        ...
        const a = d(t),
          c = d(n),
          { observersByDotNetObjectId: l, id: u } = Xe(e);
        function d(e) {
  ...
  const Ze = new Set(),
    Qe = {
      ...
      disableNavigationPrompt: function (e) {
        Ze.delete(e),
          0 === Ze.size && window.removeEventListener("beforeunload", et);
      },
    };
  function et(e) {
      ...
      _internal: {
        ...
        attachWebRendererInterop: function (t, n, r, o) {
          ...
          E.set(t, n),
            ...
            null ===
              (s = null === (i = A.get(t)) || void 0 === i ? void 0 : i[0]) ||
              void 0 === s ||
              s.call(i),
            (function (e) {
  ...
  window.Blazor = nt;
  const it = navigator,
    st = it.userAgentData && it.userAgentData.brands,
    at =
      st && st.length > 0
        ? st.some(
            (e) =>
    ...
    ct =
      null !==
        (ot =
          null === (rt = it.userAgentData) || void 0 === rt
            ? void 0
            : rt.platform) && void 0 !== ot
        ? ot
        : navigator.platform;
  function lt(e) {
    return (
      0 !== e.debugLevel && (at || navigator.userAgent.includes("Firefox"))
    );
  }
  let ut = !1;
  function dt() {
          ...
          (async function (e, n) {
            ...
            if (void 0 !== o) {
              if (e.singleRuntime) {
                ...
                let u = n;
                e.webRendererId === ft.Server && c && (u = c),
                  e.webRendererId === ft.WebAssembly && s && (u = s);
                let d = r;
                return (
                  e.webRendererId === ft.Server && l && (d = l),
                  e.webRendererId === ft.WebAssembly && a && (d = a),
                  i(e, u, d, t)
                );
              }
              return (function (e, t, n) {
                ...
                const s = n[0],
                  ...
                  p = !(l || u || d || f || m || h || (!a && !c)),
                  v = p && s.enableClassicInitializers;
                if (p && !s.enableClassicInitializers)
                  null === (o = e.logger) ||
                    void 0 === o ||
                    o.log(
                      mt.Warning,
                      `Initializer '${r}' will be ignored because multiple runtimes are available. use 'before(web|webAssembly|server)Start' and 'after(web|webAssembly|server)Started?' instead.)`
                    );
                ...
                if (
                  ...
                  f && s.webAssembly.initializers.afterStarted.push(f),
                  m && s.circuit.initializers.beforeStart.push(m),
                  h && s.circuit.initializers.afterStarted.push(h),
  ...
  const Nt = {
              ...
              r = {
                ...
                onConfigLoaded: async (n) => {
                  n.environmentVariables || (n.environmentVariables = {}),
                    ...
                    (nt._internal.getApplicationEnvironment = () =>
                      n.applicationEnvironment),
                    null == t || t(n),
                    (Et = await (async function (e, t) {
                      var n, r, o;
                      if (e.initializers)
                        return (
                          await Promise.all(
                        ...
                        );
                      {
                        const i = [
                            ...
                            null !==
                              (r =
                                null === (n = t.resources) || void 0 === n
                                  ? void 0
                                  : n.extensions) && void 0 !== r
                              ? r
                              : {},
                          ],
                          s = new ht(!0, void 0, void 0, ft.WebAssembly),
                          a = Object.keys(
                            (null === (o = null == t ? void 0 : t.resources) ||
                            void 0 === o
                              ? void 0
                              : o.libraryInitializers) || {}
                          );
                        return await s.importInitializersAsync(a, i), s;
                      }
                    })(e, n));
                },
                onDownloadResourceProgress: _t,
                config: n,
    ...
    start: function () {
      return (async function () {
        ...
        (gt = r),
          ...
          (yt = i),
          (function (e) {
            const t = ct.match(/^Mac/i) ? "Cmd" : "Alt";
            lt(e) &&
              console.info(
          ...
          (nt.runtime = wt),
          (nt._internal.dotNetCriticalError = Dt),
          o("blazor-internal", { Blazor: { _internal: nt._internal } });
        const c = await wt.getAssemblyExports(
          "Microsoft.AspNetCore.Components.WebAssembly"
        );
        return (
          Object.assign(nt._internal, {
            dotNetExports: {
              ...c.Microsoft.AspNetCore.Components.WebAssembly.Services
                .DefaultWebAssemblyJSRuntime,
            },
          }),
          (bt = e.attachDispatcher({
            beginInvokeDotNetFromJS: (e, t, n, r, o) => {
              ...
              nt._internal.dotNetExports.BeginInvokeDotNet(
                e ? e.toString() : null,
                i,
                n,
                o
            ...
            endInvokeJSFromDotNet: (e, t, n) => {
              nt._internal.dotNetExports.EndInvokeJS(n);
            },
            sendByteArray: (e, t) => {
              nt._internal.dotNetExports.ReceiveByteArrayFromJS(e, t);
            },
            invokeDotNetFromJS: (e, t, n, r) => (
              Tt(),
              nt._internal.dotNetExports.InvokeDotNet(
                e || null,
                t,
                null != n ? n : 0,
                r
    ...
    callEntryPoint: async function () {
      try {
        await wt.runMain(wt.getConfig().mainAssemblyName, []);
      } catch (e) {
        console.error(e), dt();
      }
    },
    ...
    beginHeapLock: function () {
      return Tt(), (Ct = Ot.create()), Ct;
    },
    invokeWhenHeapUnlocked: function (e) {
      Ct ? Ct.enqueuePostReleaseAction(e) : e();
    },
  };
  function _t(e, t) {
    const n = (e / t) * 100;
  ...
  const Rt = ["DEBUGGING ENABLED"],
    kt = (e) => Rt.indexOf(e) < 0 && console.log(e),
    Dt = (e) => {
      console.error(e || "(null)"), dt();
    };
  function Ft(e) {
    return e + 12;
  }
  function Tt() {
    if (Ct) throw new Error("Assertion failed - heap is currently locked");
  }
  class Ot {
    ...
    release() {
      ...
      for (
        yt.mono_wasm_gc_unlock(), Ct = null;
    ...
    static create() {
      return yt.mono_wasm_gc_lock(), new Ot();
    }
  }
  let Lt;
  class Mt {
    ...
    updatedComponents() {
      return Lt.readStructField(this.batchAddress, 0);
    }
    referenceFrames() {
      return Lt.readStructField(this.batchAddress, xt.structLength);
    }
    disposedComponentIds() {
      return Lt.readStructField(this.batchAddress, 2 * xt.structLength);
    }
    disposedEventHandlerIds() {
      return Lt.readStructField(this.batchAddress, 3 * xt.structLength);
    }
    updatedComponentsEntry(e, t) {
      return Ht(e, t, Bt.structLength);
    }
    referenceFramesEntry(e, t) {
      return Ht(e, t, jt.structLength);
    }
  ...
  const xt = {
      structLength: 8,
      values: (e) => Lt.readObjectField(e, 0),
      count: (e) => Lt.readInt32Field(e, 4),
    },
    Pt = {
      structLength: 12,
      values: (e) => {
        const t = Lt.readObjectField(e, 0),
          n = Lt.getObjectFieldsBaseAddress(t);
        return Lt.readObjectField(n, 0);
      },
      offset: (e) => Lt.readInt32Field(e, 4),
      count: (e) => Lt.readInt32Field(e, 8),
    },
    Bt = {
      structLength: 4 + Pt.structLength,
      componentId: (e) => Lt.readInt32Field(e, 0),
      edits: (e) => Lt.readStructField(e, 4),
      editsEntry: (e, t) => Ht(e, t, Jt.structLength),
    },
    Jt = {
      structLength: 20,
      editType: (e) => Lt.readInt32Field(e, 0),
      siblingIndex: (e) => Lt.readInt32Field(e, 4),
      newTreeIndex: (e) => Lt.readInt32Field(e, 8),
      moveToSiblingIndex: (e) => Lt.readInt32Field(e, 8),
      removedAttributeName: (e) => Lt.readStringField(e, 16),
    },
    jt = {
      structLength: 36,
      frameType: (e) => Lt.readInt16Field(e, 4),
      subtreeLength: (e) => Lt.readInt32Field(e, 8),
      elementReferenceCaptureId: (e) => Lt.readStringField(e, 16),
      componentId: (e) => Lt.readInt32Field(e, 12),
      elementName: (e) => Lt.readStringField(e, 16),
      textContent: (e) => Lt.readStringField(e, 16),
      markupContent: (e) => Lt.readStringField(e, 16),
      attributeName: (e) => Lt.readStringField(e, 16),
      attributeValue: (e) => Lt.readStringField(e, 24, !0),
      attributeEventHandlerId: (e) => Lt.readUint64Field(e, 8),
    };
  function Ht(e, t, n) {
    return Lt.getArrayEntryPtr(e, t, n);
  }
  const $t =
    /^\s*Blazor-WebAssembly-Component-State:(?<state>[a-zA-Z0-9+/=]+)$/;
  function zt(e, t, n = "state") {
    var r;
    if (e.nodeType === Node.COMMENT_NODE) {
      ...
      return (
        s && (null === (r = e.parentNode) || void 0 === r || r.removeChild(e)),
        s
      );
    }
        ...
        switch (s.type) {
          case "webassembly":
            return (
              ...
              (i = c),
              Zt((r = s)),
              { ...r, uniqueId: Gt++, start: o, end: i }
            );
          case "server":
            return (function (e, t, n) {
              return qt(e), { ...e, uniqueId: Gt++, start: t, end: n };
            })(s, n, c);
          case "auto":
            return (function (e, t, n) {
              return qt(e), Zt(e), { ...e, uniqueId: Gt++, start: t, end: n };
            })(s, n, c);
        }
      } catch (e) {
        throw new Error(
    ...
    resolveRegisteredElement(e) {
      ...
      if (!Number.isNaN(t))
        return (function (e) {
          ...
          if (!o)
            throw new Error(
              `Comment not connected to the DOM ${t.textContent}`
            );
          const i = P(o, !0),
            s = U(i);
          (t[M] = i), (t[x] = e);
  ...
  async function mn(e, t, n) {
    ...
    !(function (e) {
      ...
      N = (e, n, r) => {
        ((e, t, n) => {
          ...
          (null == r ? void 0 : r.eventDelegator.getHandler(t)) &&
            Nt.invokeWhenHeapUnlocked(n);
        })(e, n, () => t(e, n, r));
      };
    })(),
      (nt._internal.applyHotReload = (e, t, n, r) => {
        bt.invokeDotNetStaticMethod(
          "Microsoft.AspNetCore.Components.WebAssembly",
          "ApplyHotReloadDelta",
          e,
          t,
      ...
      (nt._internal.getApplyUpdateCapabilities = () =>
        bt.invokeDotNetStaticMethod(
          "Microsoft.AspNetCore.Components.WebAssembly",
          "GetApplyUpdateCapabilities"
        )),
      (nt._internal.invokeJSFromDotNet = pn),
      (nt._internal.invokeJSJson = vn),
      (nt._internal.endInvokeDotNetFromJS = gn),
      (nt._internal.receiveWebAssemblyDotNetDataStream = bn),
      (nt._internal.receiveByteArray = yn);
    const o = ((Lt = Nt), Lt);
    (nt.platform = o),
      (nt._internal.renderBatch = (e, t) => {
        const n = Nt.beginHeapLock();
        try {
          !(function (e, t) {
            const n = me[e];
            if (!n)
      ...
      nt._internal.navigationManager.listenForNavigationEvents(
        ft.WebAssembly,
        async (e, t, n) => {
          await bt.invokeDotNetStaticMethodAsync(
            "Microsoft.AspNetCore.Components.WebAssembly",
        ...
        async (e, t, n, r) => {
          const o = await bt.invokeDotNetStaticMethodAsync(
            "Microsoft.AspNetCore.Components.WebAssembly",
    ...
    const i = new tn(e);
    let s;
    (nt._internal.registeredComponents = {
      ...
      (nt._internal.getPersistedState = () => zt(document, $t) || ""),
      (nt._internal.getInitialComponentsUpdate = () => ln),
      (nt._internal.updateRootComponents = (e) => {
        var t;
        return null === (t = nt._internal.dotNetExports) || void 0 === t
          ? void 0
          : t.UpdateRootComponentsCore(e);
      }),
      (nt._internal.endUpdateRootComponents = (t) => {
        var n;
        return null === (n = e.onAfterUpdateRootComponents) || void 0 === n
          ? void 0
          : n.call(e, t);
      }),
      (nt._internal.attachRootComponentToElement = (e, t, n) => {
  ...
  function pn(t, n, r, o) {
    const i = Nt.readStringField(t, 0),
      s = Nt.readInt32Field(t, 4),
      a = Nt.readStringField(t, 8),
      c = Nt.readUint64Field(t, 20);
    if (null !== a) {
      const e = Nt.readUint64Field(t, 12);
  ...
  function vn(e, t, n, r, o) {
    return 0 !== o
      ? (bt.beginInvokeJSFromDotNet(o, e, r, n, t), null)
      : bt.invokeJSFromDotNet(e, r, n, t);
  }
  function gn(e, t, n) {
    bt.endInvokeDotNetFromJS(e, t, n);
  }
  function bn(e, t, n, r) {
    !(function (e, t, n, r, o) {
      let i = tt.get(t);
  ...
  let Sn = !1;
  async function An(e) {
    if (Sn) throw new Error("Blazor has already started.");
    (Sn = !0), dn(Promise.resolve(e || {})), En.create(nt);
    const t = Wt(document, "webassembly"),
      n = new wn(t);
    await fn(n);
  }
  (nt.start = An),
